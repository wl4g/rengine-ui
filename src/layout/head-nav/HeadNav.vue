          ...
          <el-dropdown-menu slot="dropdown" class="sort-menu">
            ...
            <el-container class="sort-list-container">
              <div class="dropdown-content">
                ...
                <div
                  class="dropdown-content-center"
                  style="display: flex; text-align: center"
                >
                  <!-- 基础应用 -->
                  <div
                    :class="{ baseClass: true, hoverClass: isHover }"
                    v-on:mouseover="changeActiveBase($event)"
                  >
                    基础应用
                  </div>
                  <div
                    :class="{ baseClass: true, hoverClass: !isHover }"
                    v-on:mouseover="changeActiveSave($event)"
                  >
                    安全设置
                  </div>
                </div>
                <div style="padding-top: 5px">
                  <el-dropdown-item
                    v-if="isHover"
                    style="font-size: 13px; padding: 5px 10px 5px"
                    command="pass"
                    >{{ $t("message.common.profile") }}</el-dropdown-item
                  >
                  <el-dropdown-item
                    v-if="!isHover"
                    style="font-size: 13px; padding: 5px 10px 5px"
                ...
                <div class="loginout">
                  <el-button class="loginoutButton" @click="logout"
                    >退出登录</el-button
                  >
                </div>
              </div>
    ...
    >
      ...
      >
        <el-form-item class="edit-form" label="邮箱" prop="email">
          <el-input
            v-model="dialog.user_info.email"
            disabled
            placeholder="常用邮箱"
          ></el-input>
        </el-form-item>
        <el-form-item class="edit-form" label="用户名称" prop="username">
          <el-input
            v-model="dialog.user_info.username"
            disabled
            placeholder="用户名"
          ></el-input>
        </el-form-item>
        <el-form-item class="edit-form" label="当前密码" prop="old_password">
          <el-input
            ...
            placeholder="当前密码"
            auto-complete="off"
            v-model="dialog.user_info.old_password"
          ></el-input>
        </el-form-item>
        ...
        >
          <el-input
            ...
            placeholder="确认密码"
            auto-complete="off"
            v-model="dialog.user_info.password_confirm"
          ></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
        <el-button @click="dialog.show_pass = false">取 消</el-button>
        <el-button type="primary" @click="updUserPass('user_info')"
          >确 定</el-button
        >
      </span>
    </el-dialog>
