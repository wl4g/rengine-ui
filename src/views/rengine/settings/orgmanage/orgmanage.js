...
export default {
    ...
    return {
      ...
      data: [
          ...
          children: [
            {
              ...
              nameEn: "value1",
              nameZh: "value1",
              organizationCode: "value1",
              sys_group_type: "value1",
              roleCount: "value1",
              children: [
                {
                  id: "value1-children",
                  nameEn: "value1-children",
                  nameZh: "value1-children",
                  organizationCode: "value1-children",
                  sys_group_type: "value1-children",
                  roleCount: "value1-children",
                },
              ],
            },
            {
              ...
              nameEn: "value2",
              nameZh: "value2",
              organizationCode: "value2",
              sys_group_type: "value2",
              roleCount: "value2",
            },
          ],
        },
        {
          ...
          nameEn: "value3",
          nameZh: "value3",
          organizationCode: "value3",
          sys_group_type: "value3",
          roleCount: "value3",
        },
      ],
      // 列表按钮配置
      ...
      rules: {
        ...
        organizationCode: [
          {
            required: true,
            message: "Please input organizationCode",
            trigger: "blur",
          },
        ],
        nameZh: [
  ...
  methods: {
    ...
    onClickBtnDelete(opts) {
      this.$confirm(
        "Be Careful！！！Children group will be del(Logical), and the relationship with user/role/menu will not be del",
        "Warning",
        {
          type: "warning",
        }
    ...
    onClickBtnUpdate(opts) {
      ...
      //     if (
      //       this.$refs.modulesTree &&
      //       this.saveForm.menuIds instanceof Array
      //     ) {
